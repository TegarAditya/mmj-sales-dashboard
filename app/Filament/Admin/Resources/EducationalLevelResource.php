...
use App\Filament\Admin\Resources\EducationalLevelResource\Pages;
use App\Filament\Exports\EducationalLevelExporter;
use App\Filament\Imports\EducationalLevelImporter;
...
class EducationalLevelResource extends Resource
{
    ...
    public static function infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ->schema([
                Infolists\Components\Section::make('Data Jenjang')
                    ->columns(2)
        ...
        return $table
            ...
            ->headerActions([
                Tables\Actions\ImportAction::make()
                    ->importer(EducationalLevelImporter::class),
                Tables\Actions\ExportAction::make()
                    ->exporter(EducationalLevelExporter::class),
            ]);
    }
    ...
    {
        return [
            'index' => Pages\ManageEducationalLevels::route('/'),
        ];
    }
